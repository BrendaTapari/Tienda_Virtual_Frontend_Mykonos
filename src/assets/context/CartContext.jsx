...
export const CartProvider = ({ children }) => {
  ...
  const updateQuantity = async (cartItemId, quantity) => {
    try {
      ...
      return { success: false, error: error.detail || "Error al actualizar cantidad" };
    } finally {
      setLoading(false);
    }
  };
  ...
  const removeItem = async (cartItemId) => {
    try {
      ...
      return { success: false, error: error.detail || "Error al eliminar producto" };
    } finally {
      setLoading(false);
    }
  };
  ...
  const clearCartItems = async () => {
    try {
      ...
      return { success: false, error: error.detail || "Error al vaciar el carrito" };
    } finally {
      setLoading(false);
    }
  };
